...
class BooksApiTestCase(APITestCase):
    def setUp(self):
        ...
        self.book_2 = Book.objects.create(name='Test book 2', price=55, author_name='Author2')
        self.book_3 = Book.objects.create(name='Test book 3 Author1', price=55, author_name='Author3')
    ...
    def test_get_ordering(self):
        url = reverse('book-list')
        books = Book.objects.all().annotate(
            annotated_likes=Count(Case(When(userbookrelation__like=True, then=1))),).order_by('price').order_by('id')
...
class BooksRelationTestCase(APITestCase):
    def setUp(self):
        ...
        self.user2 = User.objects.create(username='test_username2')
        self.book_1 = Book.objects.create(name='Test book 1', price=25, author_name='Author1', owner=self.user)
        self.book_2 = Book.objects.create(name='Test book 2', price=55, author_name='Author2', owner=self.user)
